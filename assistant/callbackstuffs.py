...
async def otvaar(event):
    await event.edit(
        "Other Variables to set for @THEDEMONUB:",
        buttons=[
            [
...
async def euwhe(event):
    ...
    await event.edit(
        "About [Dual Mode](https://t.me/THEDEMONUB)",
        buttons=BT,
        link_preview=False,
    )
